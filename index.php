                ...
                <ul class="menu">
                    <li class="menu-item dropdown"><a href="#">Shop</a>
                        <ul class="DropDownMenu1 dropDownMenu">
                            <li><a href="./jwelry-website/pages/all-products.php">All Jewellery</a></li>
                            <li><a href="./jwelry-website/pages/earings.php">Earringss</a></li>
                            <li><a href="./jwelry-website/pages/neckllaces.php">Necklaces</a></li>
                            <li><a href="./jwelry-website/pages/braclets.php">Bracelets</a></li>
                        </ul>
                    </li>
                    <li class="menu-item dropdown"><a href="#">Collections</a>
                        <ul class="DropDownMenu2 dropDownMenu">
                            <li><a href="./jwelry-website/pages/new_arriables.php">New Arrivals</a></li>
                            <li><a href="./jwelry-website/pages/best_sallers.php">Best Sallers</a></li>
                            <li><a href="./jwelry-website/pages/gift_ideas.php">Gift Ideas</a></li>
                            <li><a href="./jwelry-website/pages/sessonal_fabourite.php">Seasonal Fabourite</a></li>
                        </ul>
                    </li>
                    <li class="menu-item dropdown"><a href="#">About Us</a>
                        <ul class="DropDownMenu3 dropDownMenu">
                            <li><a href="./jwelry-website/pages/our_story.php">Our Story</a></li>
                            <li><a href="./jwelry-website/pages/our_story.php">Mission & Values</a></li>
                            <li><a href="./jwelry-website/pages/team.php">Meat the Team</a></li>
                        </ul>
                    </li>
                    <li class="menu-item dropdown"><a href="#">Customer Care</a>
                        <ul class="DropDownMenu4 dropDownMenu">
                            <li><a href="./jwelry-website/pages/contact.php">Contact Us</a></li>
                            <li><a href="./jwelry-website/pages/faqs.php">FAQs</a></li>
                            <li><a href="./jwelry-website/pages/Return_refund_policy.php">Return & Refound Policy</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item dropdown"><a href="./jwelry-website/pages/blogs.php">Blogs</a></li>
                </ul>
            </div>
            <div class="nav-links">
                <ul class="menu">
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-section links">
                ...
                <ul>
                    <li><a href="#">Home</a></li>
                    <li><a href="./jwelry-website/pages/all-products.php">Shop</a></li>
                    <li><a href="./jwelry-website/pages/about.php">About Us</a></li>
                    <li><a href="./jwelry-website/pages/contact.php">Contact</a></li>
                    <li><a href="./jwelry-website/pages/faqs.php">FAQs</a></li>
                    <li><a href="./jwelry-website/admin/admin_pannel.php">Admin Panel</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="footer-section support">
                ...
                <ul>
                    ...
                    <li><a href="./jwelry-website/pages/Return_refund_policy.php">Privacy Policy</a></li>
                    <li><a href="./jwelry-website/pages/terms.php">Terms & Conditions</a></li>
                </ul>
            </div>
